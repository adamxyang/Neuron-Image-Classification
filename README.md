...
Our results align with biologists' statistical analysis using [CellProfiler](aaA)(https://cellprofiler.org). But once our model is trained, the inference time was 1000 time faster than the traditional method using CellProfiler. We also implemented GradCAM to visualise pixel-wise importance:
<p align="center">
